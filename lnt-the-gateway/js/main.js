...
// Form Submit Operations
    ...
    }else if(typeofDataForm == "Play Video"){
        $(".loadMessage").html("Thank you for your enquiry<br>Our Sales Advisor will call you in 30 mins")
    }
...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://thegateway-sewri.com")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://thegateway-sewri.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
