...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $salesnumber = "919136041127";
    $logolink = "https://riogapremium.in/email/godrej-avenue-eleven/logo.png";
    $bannerlink = "https://riogapremium.in/email/godrej-avenue-eleven/banner.webp";
        ...
        "recipients" => [
            [
                "to" => [
                    ...
                    ["name" => "Mohit A", "email" => "mohita@riogapremium.com"],
