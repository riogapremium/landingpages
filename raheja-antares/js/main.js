...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/Raheja-k';
        let website = 'https://rahejaantares-kanjurmarg.com/';
        let salesnumber = '917700933233';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://rahejaantares-kanjurmarg.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://rahejaantares-kanjurmarg.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
