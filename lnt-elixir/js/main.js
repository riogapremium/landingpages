...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/lnt-elixir';
        let website = 'https://elixirreserve.com/';
    ...
    .then(emailResponse => {
        ...
        // if($(location).attr("href") == "https://elixirreserve.com/")
        // {
        //     variques = "?"
        // }
        // else{
        ...
        window.location.href = "https://elixirreserve.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
