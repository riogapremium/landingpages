...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->setFrom('enquiry.rp@riogapremium.com', 'Godrej City');
        
        // First email to user
        $mail->addAddress($email, $name);
        $mail->Subject = 'Thank you for enquiry - Godrej City';
        $mail->isHTML(true);
        $mail->Body = "
            Dear $namenew!,<br>
            <br>
            Warm greetings!<br>
            <br>
            Thank you for expressing your interest in Godrej City. We have received your request and one of our dedicated sales experts will reach out to you within the next 30 minutes to provide detailed information about the project.<br>
            <br>
            Should you wish to speak to us directly in the meantime, feel free to call us at +917400466339 or<br>
            <a href='https://wa.me/+917400466339?text=I’m+interested+in+the+Godrej+City+project.+Please+send+brochure+and+price+details.'>Click Here to instantly Connect on WhatsApp</a><br>
            <br>
        ...
        $recipients = [
            ...
            // 'prachij@riogapremium.com' => 'Prachi J',
            'hiteshj@riogapremium.com' => 'Hitesh J',
            'pawank@riogapremium.com' => 'Pawan K',
            // 'minakshiv@riogapremium.com' => 'minakshi J',
        ...
        $mail->Subject = 'Lead Alert - Godrej City';
        $mail->Body = "
            Hi,<br>
            <br>
            Here are the Lead details of Godrej City<br>
            <br><br>
    ...
    \"realTimeResponse\": \"1\", \n  
    \"recipients\": [\n    {\n      
    \"mobiles\": \"917400466339, 917506525717, 917400493119\",\n      
