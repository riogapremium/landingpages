...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://docs.google.com/spreadsheets/d/1YBaugErWr1iJBsVDRS0SmL7oUY0_Kg3VHamAkE1X0FA/edit?gid=0#gid=0', {
        method: "POST",
        body: data
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://horizons-dadar-wadala.com/new-tower-launch")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://horizons-dadar-wadala.com/new-tower-launch?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
