...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://pre-launch-project.com/raheja-juinagar")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://pre-launch-project.com/raheja-juinagar?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
