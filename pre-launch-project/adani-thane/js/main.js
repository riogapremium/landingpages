...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://pre-launch-project.com/adani-thane/")
        {
            variques = "?"
        }
        else{
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://pre-launch-project.com/adani-thane?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
