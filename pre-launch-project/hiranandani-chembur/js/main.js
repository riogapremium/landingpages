...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanbackDrop").each(function(){
            if($(this).attr("data-configDetails") != "7 BHK" ){
...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://pre-launch-project.com/hiranandani-chembur")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://pre-launch-project.com/hiranandani-chembur?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
