...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/R-chmbur';
        let website = 'https://pre-launch-project.com/rustomjee-bandra/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://pre-launch-project.com/rustomjee-bandra?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
