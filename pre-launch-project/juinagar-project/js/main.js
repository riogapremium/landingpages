...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/KRHJA-juingr';
        let website = 'https://pre-launch-project.com/juinagar-project/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://pre-launch-project.com/juinagar-project")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://pre-launch-project.com/juinagar-project?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
