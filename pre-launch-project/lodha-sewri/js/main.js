...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanbackDrop").each(function(){
            if( $(this).attr("data-configDetails") == "3 BHK"  || $(this).attr("data-configDetails") == "4 BHK" || $(this).attr("data-configDetails") == "2 BHK" ){
...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://pre-launch-project.com/lodha-sewri")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://pre-launch-project.com/lodha-sewri?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
