...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let website = 'https://pre-launch-project.com/runwal-chembur/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://pre-launch-project.com/runwal-chembur?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
