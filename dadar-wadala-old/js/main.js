...
// Form Submit Operations
    ...
    }else if(typeofDataForm == "Schedule Meeting" || typeofDataForm == "Enquire Now" || typeofDataForm == "Know More" || typeofDataForm == "Video"){
...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        priceBtn = $(this)
        projname = 'Rioga Premium - Dadar - Wadala'

        $("#typeofForm").attr("value",formtype)

        if(formtypeData == "Schedule Meeting"){
            $("#sitevisitform").show()
        }
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        emailData.append('projname', form.project_name.value || ''); 
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://newprojects-mumbai.com/dadar-wadala-matunga-projects")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://newprojects-mumbai.com/dadar-wadala-matunga-projects?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
