...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $salesnumber = "917738055388";
    $logolink = "https://newprojects-mumbai.com/dadar-wadala-matunga-projects/email/logo.png";
    $bannerlink = "https://newprojects-mumbai.com/dadar-wadala-matunga-projects/email/banner.webp";
        ...
        "recipients" => [
            [
                "to" => [
                    ...
                    ["name" => "Kokila T", "email" => "kokilat@riogapremium.com"]
                ],
                "variables" => [
                    "projname" => $ProjectName,
                    "username" => $namenew,
