...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $salesnumber = "919930077799";
    $logolink = "https://riogapremium.in/godrej-homes-mumbai/email/logo.png";
    $bannerlink = "https://riogapremium.in/godrej-homes-mumbai/email/banner.webp";
        ...
        "recipients" => [
            [
                "to" => [
                    ...
                    ["name" => "Amit Rajpal", "email" => "amitr@riogapremium.com"]
                ],
                "variables" => [
                    "projname" => $ProjectName,
                    "username" => $namenew,
