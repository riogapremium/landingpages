...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbzsEwO94LmMEf1dbjuooAu1g4JpQAQN5wuM2X-BUf4-rKJnvCWyLYQmGGrUtZkv7yWRfg/exec', {
        method: "POST",
        body: data
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://panvel-fortunecity.com/domestic-dg")
        {
            variques = "?"
        }
        else{
