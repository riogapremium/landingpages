...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ProjectName = htmlspecialchars($_POST['projname'] ?? '');
    $link = "bit.ly/HFC-pnvl";
    ...
    try {
        ...
        $mail->Body = "
            ...
            <br>
            Should you wish to speak to us directly in the meantime, feel free to call us at +917304409909 or<br>
            <a href='https://wa.me/+917304409909?text=I’m+interested+in+the+Hiranandani+Fortune+City+project.+Please+send+brochure+and+price+details.'>Click Here to instantly Connect on WhatsApp</a><br>
            <br>
    ...
    \"realTimeResponse\": \"1\", \n  
    \"recipients\": [\n    {\n      
    \"mobiles\": \"917304409909, 917506525717, 917400493119\",\n      
