...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ProjectName = "Rustomjee Golf";
    $link = "bit.ly/rstmj-chm";
    ...
    try {
        ...
        $mail->Body = "
            ...
            <a href='https://wa.me/+917738055388?text=I’m+interested+in+the+Rustomjee+Golf.+Please+send+brochure+and+price+details.'>Click Here to instantly Connect on WhatsApp</a><br>
            <br>
        ...
        $recipients = [
            ...
            'kokilat@riogapremium.com' => 'Aasim S',
        ...
        $mail->Subject = 'Lead Alert - Rustomjee Golf';
        $mail->Body = "
            Hi,<br>
            <br>
            Here are the Lead details of Rustomjee Golf<br>
            <br><br>
    ...
    \"realTimeResponse\": \"1\", \n  
    \"recipients\": [\n    {\n      
    \"mobiles\": \"917738055388, 917400493119\",\n      
