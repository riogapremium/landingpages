...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/Adani-LIT-Thne';
        let website = 'adani-lit-thane.com/';
    ...
    .then(emailResponse => {
        ...
        // if($(location).attr("href") == "https://adani-lit-thane.com/")
        // {
        //     variques = "?"
        // }
        // else{
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://adani-lit-thane.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
